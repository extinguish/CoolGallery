...
public class CenteredLinearLayout extends LinearLayout {
    ...
    public CenteredLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, com.android.gallery3d.R.styleable.CenteredLinearLayout);
        mMaxWidth = typedArray.getDimensionPixelSize(com.android.gallery3d.R.styleable.CenteredLinearLayout_max_width, 0);
        typedArray.recycle();
    }
